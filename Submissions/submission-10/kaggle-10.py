...
averaged_models = AveragingModels(models = (xgb_model, enet_model, lasso_model, krr_model))
...
# Saving to CSV
pd.DataFrame({'Id': test_ID, 'SalePrice': final_labels}).to_csv('submission-10.csv', index =False)
