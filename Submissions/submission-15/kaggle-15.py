...
categorical_features = ('BsmtFinType1', 'BsmtFinType2', 'Functional', 'Fence', 'BsmtExposure', 'LandSlope',
        'SimplifiedBsmtFinType1', 'SimplifiedBsmtFinType1', 'SimplifiedBsmtFinType2', 'SimplifiedFunctional',
        'SimplifiedFence', 'SimplifiedBsmtExposure', 'LandSlope', 'LotShape', 'PavedDrive', 'Street',
...
# Saving to CSV
pd.DataFrame({'Id': test_ID, 'SalePrice': final_labels}).to_csv('submission-15.csv', index =False)
